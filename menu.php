        ...
        <div class="container">
            ...
            <div class="w3-grid-template">
                ...
                foreach ($rows as $subjects) {
                    ...
                    $sname = truncate($subjects['subject_name'], 15);
                    $sdesc = $subjects['subject_description'];
                    echo "<div class='w3-card-4 w3-round' style='margin:10px;'>";
                    echo "<img class='w3-image' src=assets/courses/$sid.png" .
                    " onerror=this.onerror=null;this.src='res/avatar.jpg'"
                    . " style='width:100%;height:250px'><hr style='margin-bottom:0px'>";
                    echo "<div class='w3-container w3-padding'><p><center><h4><b>$sname</b></h4><br>$sdesc<br><br><a href='subjectdetails.php?sid=$sid' class='w3-button w3-purple' style='text-decoration:none;'>More Details</a></center></p></div>
                    </div>";
                }
                ?>
            </div>
            ...
            for ($page = 1; $page <= $number_of_page; $page++) {
                echo '<a href = "menu.php?pageno=' . $page . '" style=
